...
import './SentenceUnderstanding.css';

const SentenceUnderstanding = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const api = await fetch(props.suApi);
    ...
    return (
        <>
            <div>
                <h2 id='learn'>Test Your Sentence Understanding Knowledge!</h2>
            </div>
            <div className='box'>
...
export default SentenceUnderstanding;
